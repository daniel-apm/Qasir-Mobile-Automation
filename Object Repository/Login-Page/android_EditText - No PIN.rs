...
<MobileElementEntity>
   ...
   <name>android_EditText - No PIN</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'No PIN' or . = 'No PIN') and @resource-id = 'com.innovecto.etalastic:id/login_content_customEditText_pin']</locator>
