...
<MobileElementEntity>
   ...
   <name>android_EditText - No. Handphone</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'No. Handphone' or . = 'No. Handphone') and @resource-id = 'com.innovecto.etalastic:id/login_content_customEditText_phone']</locator>
